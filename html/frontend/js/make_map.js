function makeMap() {
	document.getElementById("display-section").innerHTML = "<div id='mapid'></div>";
	...
	httpRoute.responseType = "json";
	httpRoute.send();

	httpRoute.onreadystatechange = (e) => {

		if(httpRoute.readyState == 4 && httpRoute.status == 200) {
			// Route coordinates
			let latlons = httpRoute.response;
